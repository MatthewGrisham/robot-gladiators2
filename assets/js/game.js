...
// conver promptFight to all lowercase so we can check with less options
promptFight = promptFight.toLowerCase();
  ...
  if (promptFight === "skip") {
    ...
    if (confirmSkip) {
      ...
      playerInfo.playerMoney = Math.max(0, playerInfor.money - 10);
...
var fight = function(enemy) {
  while (playerInfo.health > 0 && enemy.health > 0) {
    // ask playe rif they'd like to fightr or skip using fightOrSKip function
    if (fightOrSkip()) {
...
var getPlayerName = function() {
  ...
  console.log("Your robt's name is " + name);
  return name;
};
